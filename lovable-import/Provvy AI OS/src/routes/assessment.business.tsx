...
export const Route = createFileRoute("/assessment/business")({
...
function BusinessScreen() {
  ...
  const handleContinue = () => {
    ...
    navigate({ to: "/assessment/connect" });
  };
  ...
  return (
    <section className="relative px-6 pt-14 pb-24 animate-fade-up">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_380px]">
        <div>
          <Link to="/assessment" className="mb-6 inline-flex items-center gap-1.5 text-[13px] text-ink-soft hover:text-foreground">

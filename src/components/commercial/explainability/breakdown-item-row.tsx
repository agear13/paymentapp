...
import { opChipDanger, opChipInfo, opChipNeutral, opChipSuccess, opChipWarning } from '@/lib/design/operational-surfaces';
...
const STATUS_BADGE_CLASS: Record<StatusVariant, string> = {
  confirmed: opChipSuccess,
  pending:   opChipInfo,
  forecast:  'border-purple-500/20 bg-purple-500/[0.08] text-purple-800 dark:text-purple-400',
  overdue:   opChipDanger,
  warning:   opChipWarning,
  neutral:   opChipNeutral,
};

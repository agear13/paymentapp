 ...
 * Dashboard and Commercial OS pass surface-specific backHref.
 */
export function SupplierOnboardingFormScreen({
  participantId,
  backHref,
}: {
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4" data-testid="supplier-onboarding-form-screen">
      <div className="mb-6">
        <Link
          href={backHref}
          data-testid="onboard-back-link"

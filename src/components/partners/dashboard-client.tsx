...
export function DashboardClient({ totalEarnings, pendingEarnings, paidOut }: DashboardClientProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${paidOut.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <ChartContainer config={chartConfig} className="h-[300px]">
            <AreaChart data={mockEarningsChartData}>
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              {mockAttributedEntities.map((entity) => (

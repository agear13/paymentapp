  ...
  switch (stage) {
    ...
    case 'awaiting_operator_review':
      return {
        ...
        message: `${participantName} submitted their bank details, ABN, and GST status. Review and approve payout details.`,
        urgency: 'action_required',
    ...
    case 'awaiting_xero_export':
      return {
        ...
        participantId,
        participantName,
        title: `${participantName} is ready for optional Xero export`,
        message: `Payout details for ${participantName} are verified. You can export to Xero for accounting — this does not gate payment.`,
        urgency: 'informational',
    ...
    case 'awaiting_funding':
      return {
        ...
        participantId,
        participantName,
        title: `${participantName}'s payout details are verified`,
        message: `Payout details are verified for ${participantName}. Awaiting revenue collection to fund the obligation.`,
        urgency: 'informational',

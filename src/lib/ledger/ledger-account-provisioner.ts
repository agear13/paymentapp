...
const STRIPE_REQUIRED_ACCOUNTS = [
  { code: LEDGER_ACCOUNTS.STRIPE_CLEARING, name: 'Cash / Bank', account_type: 'ASSET' as const },
  { code: LEDGER_ACCOUNTS.ACCOUNTS_RECEIVABLE, name: 'Stripe Clearing', account_type: 'ASSET' as const },

...
export function deriveFundingCoordinationStage(
  ...
  let primaryLabel = 'No funding source connected';
  let blockerLabel: string | null = 'Connect a funding source';

  if (fundingSourceConnected && !fundingReserved) {
    ...
    primaryLabel = 'Funding settled — awaiting obligation allocation';
    blockerLabel = 'Obligations not yet fully funded for release';

...
export const Route = createFileRoute("/assessment/connect")({
...
function ConnectScreen() {
  ...
  const connect = () => {
    ...
    navigate({ to: "/assessment/analysis" });
  };
  const skip = () => {
    try {
  ...
  return (
    <section className="relative px-6 pt-14 pb-24 animate-fade-up">
      <div className="mx-auto max-w-3xl">
        <Link to="/assessment/business" className="mb-6 inline-flex items-center gap-1.5 text-[13px] text-ink-soft hover:text-foreground">
